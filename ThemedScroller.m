...
//  LightCue
//
//  Created by Jonas Jongejan on 16/06/10.
//  Copyright 2010 HalfdanJ. All rights reserved.
//

#import "ThemedScroller.h"
...
@interface ThemedScroller (MyPrivate)
- (void)drawKnobSlot;
@end

@interface NSScroller (MyPrivate)
- (NSRect)_drawingRectForPart:(NSScrollerPart)aPart;
@end

@implementation ThemedScrollerLighter
...
+ (void)initialize
{
	NSBundle *bundle = [NSBundle bundleForClass:[ThemedScroller class]];
